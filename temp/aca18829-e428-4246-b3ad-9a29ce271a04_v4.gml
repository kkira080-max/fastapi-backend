...
<FeatureCollection
    ...
    timeStamp="2026-02-03T08:10:31"
    numberMatched="1"
    numberReturned="1">
  <member>
    <cp:CadastralParcel gml:id="ES.SDGC.CP.30044A00300163_MOD">
      ...
      <cp:geometry>
        <gml:MultiSurface gml:id="MultiSurface_30044A00300163_MOD" srsName="urn:ogc:def:crs:EPSG::25830">
          <gml:surfaceMember>
            <gml:Surface gml:id="Surface_30044A00300163_MOD.1" srsName="urn:ogc:def:crs:EPSG::25830">
              <gml:patches>
                <gml:PolygonPatch>
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <cp:inspireId>
        <Identifier xmlns="http://inspire.ec.europa.eu/schemas/base/3.3">
          <localId>30044A00300163_MOD</localId>
          <namespace>ES.LOCAL.CP</namespace>
        </Identifier>
      </cp:inspireId>
      <cp:label>30044A00300163_MOD</cp:label>
      <cp:nationalCadastralReference>30044A00300163_MOD</cp:nationalCadastralReference>
    </cp:CadastralParcel>
  </member>
</FeatureCollection>