...
<FeatureCollection
    ...
    timeStamp="2026-02-02T21:51:38"
    numberMatched="1"
    numberReturned="1">
  <member>
    <cp:CadastralParcel gml:id="ES.SDGC.CP.FR-4107">
      ...
      <cp:geometry>
        <gml:MultiSurface gml:id="MultiSurface_FR-4107" srsName="urn:ogc:def:crs:EPSG::25830">
          <gml:surfaceMember>
            <gml:Surface gml:id="Surface_FR-4107.1" srsName="urn:ogc:def:crs:EPSG::25830">
              <gml:patches>
                <gml:PolygonPatch>
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <cp:inspireId>
        <Identifier xmlns="http://inspire.ec.europa.eu/schemas/base/3.3">
          <localId>FR-4107</localId>
          <namespace>ES.LOCAL.CP</namespace>
        </Identifier>
      </cp:inspireId>
      <cp:label>FR-4107</cp:label>
      <cp:nationalCadastralReference>FR-4107</cp:nationalCadastralReference>
    </cp:CadastralParcel>
  </member>
</FeatureCollection>